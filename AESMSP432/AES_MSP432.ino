...
uint8_t Data2[16] = { 0x32, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff };
...
//  AESASTAT |= AESKEYWR;
  ...
  for(i = 0; i < 16; i = i + 2){
    /* Concatenate 2 8-bit blocks into one 16-bit block */
    tempVariable = (uint16_t)(Data2[i]);
    tempVariable = tempVariable | ((uint16_t)(Data2[i + 1]) << 8);
    /* Load 16-bit key block to AESADIn register */
    AESADIN = tempVariable;
  }
